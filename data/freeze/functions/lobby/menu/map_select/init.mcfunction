...
#Start game button
summon text_display -1330.6875 61.725 295.93 {Tags:["MapSelect"],text:'{"text":"Start Game"}',background:0,Rotation:[180f,0f]}
summon interaction -1330.6875 61.4375 296.97 {response:1b,width:2f,height:0.5f,Tags:["MenuInteract","MapSelect"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/map_select/interactions/start_game",Args:{}}}]}
