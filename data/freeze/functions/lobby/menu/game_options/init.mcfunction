...
#Background
summon item_display -1336.998 63.0 292.50 {Rotation:[90F,0F],Tags:["GameOptions"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[5f,4f,0.001f]},item:{id:"minecraft:phantom_membrane",count:1,components:{"minecraft:custom_model_data":22}}}
...
summon item_display -1336.996 65.0 292.5 {Rotation:[-90F,0F],Tags:["GameOptions"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2.625f,2.625f,0.001f]},item:{id:"minecraft:phantom_membrane",count:1,components:{"minecraft:custom_model_data":26}}}
