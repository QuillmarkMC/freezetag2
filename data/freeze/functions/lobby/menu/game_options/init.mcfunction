...
summon text_display -1336.95 63.75 293.1 {line_width:120,Tags:["GameOptions","Option1"],text:'{"text":"                                Win Score:"}',background:0,Rotation:[-90f,0f],alignment:"left"}
summon text_display -1336.95 63.0 293.1 {line_width:120,Tags:["GameOptions","Option2"],text:'{"text":"                                Freeze Time:"}',background:0,Rotation:[-90f,0f],alignment:"left"}
summon text_display -1336.95 62.25 293.1 {line_width:120,Tags:["GameOptions","Option3"],text:'{"text":"                                Heat Time:"}',background:0,Rotation:[-90f,0f],alignment:"left"}
summon text_display -1336.95 61.5 293.1 {line_width:120,Tags:["GameOptions","Option4"],text:'{"text":"                                OT Deduction:"}',background:0,Rotation:[-90f,0f],alignment:"left"}
...
summon text_display -1336.95 63.0 292.5 {line_width:40,Tags:["GameOptions","Value2"],text:'{"text":"           10"}',background:0,Rotation:[-90f,0f],alignment:"right"}
summon text_display -1336.95 62.25 292.5 {line_width:40,Tags:["GameOptions","Value3"],text:'{"text":"           10"}',background:0,Rotation:[-90f,0f],alignment:"right"}
summon text_display -1336.95 61.5 292.5 {line_width:40,Tags:["GameOptions","Value4"],text:'{"text":"           100"}',background:0,Rotation:[-90f,0f],alignment:"right"}
