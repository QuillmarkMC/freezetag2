...
#Title
summon text_display -1336.996 64.75 292.5 {Tags:["MapSelect"],text:'{"text":"Game Options"}',background:0,Rotation:[-90f,0f],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f]}}
summon item_display -1336.992 65.0 292.5 {Tags:["MapSelect"],item:{id:"minecraft:phantom_membrane",tag:{CustomModelData:26},Count:1b},Rotation:[-90f,0f],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2.25f,2.25f,0f]}}
...
summon interaction -1337.315 63.7500 291.37 {response:1b,width:0.75f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/edit/1",Args:{}}}]}
summon interaction -1337.315 63.0000 291.37 {response:1b,width:0.75f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/edit/2",Args:{}}}]}
summon interaction -1337.315 62.2500 291.37 {response:1b,width:0.75f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/edit/3",Args:{}}}]}
summon interaction -1337.315 61.5000 291.37 {response:1b,width:0.75f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/edit/4",Args:{}}}]}
...
summon text_display -1336.93 63.0625 290.665 {Tags:["GameOptions"],text:'{"text":"?"}',background:0,Rotation:[-90f,0f]}
summon text_display -1336.93 62.3125 290.665 {Tags:["GameOptions"],text:'{"text":"?"}',background:0,Rotation:[-90f,0f]}
summon text_display -1336.93 61.5625 290.665 {Tags:["GameOptions"],text:'{"text":"?"}',background:0,Rotation:[-90f,0f]}
summon interaction -1337.1025 63.7500 290.65 {response:1b,width:0.425f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/info/1",Args:{}}}]}
summon interaction -1337.1025 63.0000 290.65 {response:1b,width:0.425f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/info/2",Args:{}}}]}
summon interaction -1337.1025 62.2500 290.65 {response:1b,width:0.425f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/info/3",Args:{}}}]}
summon interaction -1337.1025 61.5000 290.65 {response:1b,width:0.425f,height:0.425f,Tags:["MenuInteract","GameOptions"],Passengers:[{id:"minecraft:marker",Tags:["MapSelect"],data:{Function:"freeze:lobby/menu/game_options/interactions/info/4",Args:{}}}]}
