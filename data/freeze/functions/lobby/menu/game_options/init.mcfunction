...
summon text_display -1336.95 63.75 292.9 {line_width:40,Tags:["GameOptions","Value1"],text:'{"text":"           3000"}',background:0,Rotation:[-90f,0f],alignment:"right"}
summon text_display -1336.95 63.0 292.9 {line_width:40,Tags:["GameOptions","Value2"],text:'{"text":"           10"}',background:0,Rotation:[-90f,0f],alignment:"right"}
summon text_display -1336.95 62.25 292.9 {line_width:40,Tags:["GameOptions","Value3"],text:'{"text":"           10"}',background:0,Rotation:[-90f,0f],alignment:"right"}
summon text_display -1336.95 61.5 292.9 {line_width:40,Tags:["GameOptions","Value4"],text:'{"text":"           100"}',background:0,Rotation:[-90f,0f],alignment:"right"}
