...
scoreboard players remove $selected_item_page var 1
execute if score $selected_item_page var matches ..-1 run scoreboard players set $selected_item_page var 2
