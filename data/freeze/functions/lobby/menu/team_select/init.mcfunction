...
#Interactions
summon interaction -1333.5 61.7 278.3 {height:2,response:1b,Tags:["MenuInteract","TeamSelect"],Passengers:[{id:"minecraft:marker",Tags:["TeamSelect"],data:{Function:"freeze:lobby/menu/team_select/interactions/blue"}}]}
summon interaction -1329.5 61.7 278.3 {height:2,response:1b,Tags:["MenuInteract","TeamSelect"],Passengers:[{id:"minecraft:marker",Tags:["TeamSelect"],data:{Function:"freeze:lobby/menu/team_select/interactions/red"}}]}
summon interaction -1331.5 61.7 278.3 {height:2,response:1b,Tags:["MenuInteract","TeamSelect"],Passengers:[{id:"minecraft:marker",Tags:["TeamSelect"],data:{Function:"freeze:lobby/menu/team_select/interactions/random"}}]}
summon interaction -1337.7 61.7 280.5 {height:2,response:1b,Tags:["MenuInteract","TeamSelect"],Passengers:[{id:"minecraft:marker",Tags:["TeamSelect"],data:{Function:"freeze:lobby/menu/team_select/interactions/spectate"}}]}
summon interaction -1325.3 61.7 280.5 {height:2,response:1b,Tags:["MenuInteract","TeamSelect"],Passengers:[{id:"minecraft:marker",Tags:["TeamSelect"],data:{Function:"freeze:lobby/menu/team_select/interactions/spectate"}}]}
