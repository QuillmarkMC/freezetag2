...
execute if entity @s[advancements={freeze:general/attacked={is_team_blue=true}},team=Red] run function freeze:game/general/freezing/pvp/hit_by_enemy
execute if entity @s[advancements={freeze:general/attacked={is_team_red=true}},team=Blue] run function freeze:game/general/freezing/pvp/hit_by_enemy
