...
execute if score $countdown var matches 0 run function freeze:game/general/map/intro/frozen_crag/end
execute unless score $countdown var matches 0 run schedule function freeze:game/general/map/intro/frozen_crag/countdown 1s replace