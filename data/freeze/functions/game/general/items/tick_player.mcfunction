...
#Bow
execute if score @s use_bow matches 1.. run function freeze:game/general/items/bow/use with entity @s SelectedItem.tag

#Campfire
execute if score @s campfire_time matches 1.. at @s run function freeze:game/general/items/blaze/tick

#Crossbow
execute if score @s use_crossbow matches 1.. run function freeze:game/general/items/crossbow/use with entity @s SelectedItem.tag
