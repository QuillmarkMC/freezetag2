data merge entity @s {Tags:["Ball"],Item:{id:"minecraft:snowball",Count:1b}}
...
execute summon marker run function freeze:game/general/items/avalanche/init_ball_rider with storage freeze:var BallRiderInit