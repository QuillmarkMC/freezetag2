...
execute if data storage freeze:var {GlacierbackInit:{Team:"Blue"}} run data merge entity @s {Tags:["Turtle"],item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:8,Team:"Red"}},transformation:{translation:[0.0f,0.3f,0.0f],scale:[0.65f,0.65f,0.65f]}}
