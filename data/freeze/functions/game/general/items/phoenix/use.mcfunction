...
execute if entity @s[team=Blue] at @s as @a[distance=..16,team=Blue] run function freeze:game/general/freezing/states/unfreeze
execute if entity @s[team=Red] at @s as @a[distance=..16,team=Red] run function freeze:game/general/freezing/states/unfreeze
kill @s