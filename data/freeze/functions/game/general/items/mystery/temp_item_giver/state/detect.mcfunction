#Give item
execute positioned ~-0.5 ~-0.6 ~-0.5 as @p[distance=..5,scores={item=-1},tag=!Frozen,team=!Spectate] run function freeze:game/general/item_giver/generate_item/run {Items:InPlayItems,Slot:0,Blacklist:["mystery"]}
