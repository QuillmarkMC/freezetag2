...
execute if score @s temp_item_giver_timer matches ..0 run function freeze:game/general/items/mystery/temp_item_giver/clean with entity @s item.components.minecraft:custom_data
