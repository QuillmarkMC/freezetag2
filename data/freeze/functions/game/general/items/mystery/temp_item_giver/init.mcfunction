data merge entity @s {item:{id:"minecraft:phantom_membrane",Count:1b,tag:{CustomModelData:1}},Tags:["TempItemGiver","TempItemGiverCore"],Rotation:[0f,36f],teleport_duration:1}
