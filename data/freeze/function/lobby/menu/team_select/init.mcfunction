...
#Coats
summon armor_stand -1333.5 62 278.5 {Marker:1b,Invisible:1b,Tags:["TeamSelect"],equipment:{chest:{id:"minecraft:iron_chestplate",count:1b,components:{equippable:{slot:chest,asset_id:"freeze:humanoid/blue"}}}},Rotation:[0f,0f]}
summon armor_stand -1329.5 62 278.5 {Marker:1b,Invisible:1b,Tags:["TeamSelect"],equipment:{chest:{id:"minecraft:iron_chestplate",count:1b,components:{equippable:{slot:chest,asset_id:"freeze:humanoid/red"}}}},Rotation:[0f,0f]}
summon armor_stand -1331.5 62 278.5 {Marker:1b,Invisible:1b,Tags:["TeamSelect"],equipment:{chest:{id:"minecraft:iron_chestplate",count:1b,components:{equippable:{slot:chest,asset_id:"freeze:humanoid/random"}}}},Rotation:[0f,0f]}
summon armor_stand -1337.5 62 280.5 {Marker:1b,Invisible:1b,Tags:["TeamSelect"],equipment:{chest:{id:"minecraft:iron_chestplate",count:1b,components:{equippable:{slot:chest,asset_id:"freeze:humanoid/spectator"}}}},Rotation:[-90f,0f]}
summon armor_stand -1325.5 62 280.5 {Marker:1b,Invisible:1b,Tags:["TeamSelect"],equipment:{chest:{id:"minecraft:iron_chestplate",count:1b,components:{equippable:{slot:chest,asset_id:"freeze:humanoid/spectator"}}}},Rotation:[90f,0f]}
...
summon text_display -1329.5 62 278.5 {Tags:["TeamSelect"],text:[{"translate":"text.lobby.menu.team_select.prompt"},{"translate":"text.lobby.menu.team_select.red","color":"red"}],billboard:"center",alignment:"center"}
summon text_display -1331.5 62 278.5 {Tags:["TeamSelect"],text:[{"translate":"text.lobby.menu.team_select.prompt"},{"translate":"text.lobby.menu.team_select.random","color":"dark_purple"}],billboard:"center",alignment:"center"}
summon text_display -1337.5 62 280.5 {Tags:["TeamSelect"],text:[{"translate":"text.lobby.menu.team_select.prompt"},{"translate":"text.lobby.menu.team_select.spectator","color":"gray"}],billboard:"center",alignment:"center"}
summon text_display -1325.5 62 280.5 {Tags:["TeamSelect"],text:[{"translate":"text.lobby.menu.team_select.prompt"},{"translate":"text.lobby.menu.team_select.spectator","color":"gray"}],billboard:"center",alignment:"center"}
