...
summon item_display -1336.96875 64.5000 294.325 {Tags:["GameOptions","AdminLock"],item:{id:"minecraft:phantom_membrane",components:{"minecraft:custom_model_data":25}},Rotation:[90f,0f],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]}}
