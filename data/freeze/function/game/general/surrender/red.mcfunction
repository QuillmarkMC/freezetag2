...
execute if score $red_surrender var >= $red_surrender_teammates var run function freeze:game/general/surrender/win {Team:"Blue",Color:"aqua",Translate:"text.game.cutscene.team_wins.blue"}