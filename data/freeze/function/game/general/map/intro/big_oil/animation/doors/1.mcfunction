...
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1007.5 59 -220.5 2 0.1 0.1 1 20 force
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1015.5 59 -227.5 0.1 0.1 1.5 1 20 force
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1007.5 59 -234.5 2 0.1 0.1 1 20 force
...
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1109.5 59 -234.5 2 0.1 0.1 1 20 force
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1101.5 59 -227.5 0.1 0.1 1.5 1 20 force
particle minecraft:block{block_state:"minecraft:spruce_fence"} 1109.5 59 -220.5 2 0.1 0.1 1 20 force
