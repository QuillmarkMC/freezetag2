...
execute as @e[type=armor_stand,tag=IntroStand] at @s run function freeze:game/general/map/intro/tdm/stand/tick with entity @s equipment.mainhand.components.minecraft:custom_data
